...
export class OwnerRepoService {
    ...
    findAllSync(limit?: number): Owner[] {
    ...
    findPeopleByListSync(ids?: string[]): Owner[] {
    ...
    updateSync(id: string, update: Partial<Owner>): Owner {
